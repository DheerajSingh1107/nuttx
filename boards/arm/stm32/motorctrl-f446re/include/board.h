 ...
 *
 * The board provides:
 * - LD2 on PA5 (on-board user LED)
 * - Indicator LED on PC5 (external/user indicator)
 *
...
#define BOARD_LD2           0
#define BOARD_LED_INDICATOR 1
#define BOARD_NLEDS         2

/* LED bits for use with board_userled_all() */

#define BOARD_LD2_BIT           (1 << BOARD_LD2)
#define BOARD_LED_INDICATOR_BIT (1 << BOARD_LED_INDICATOR)
...
/* Indicator LED output on PC5 (active high). */

#define GPIO_LED_INDICATOR (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_50MHz| \
                            GPIO_OUTPUT_CLEAR|GPIO_PORTC|GPIO_PIN5)

/* External gate-driver enable for TIM1 PWM stage (active high on PA11). */

#if defined(CONFIG_STM32_TIM1_PWM)
#  define GPIO_TIM1_ENABLE (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_50MHz| \
                            GPIO_OUTPUT_SET|GPIO_PORTA|GPIO_PIN11)
#endif

/* TIM1 PWM mapping used by custom motor-control stages:
 * CH1/CH2/CH3 on PA8/PA9/PA10 and complementary outputs on PA7/PB0/PB1.
 * Keep these as defaults when no board-specific override is provided.
 */

#if defined(CONFIG_STM32_TIM1_PWM) && !defined(GPIO_TIM1_CH1OUT)
...
#  define GPIO_TIM1_CH3NOUT  GPIO_TIM1_CH3N_1
#  define GPIO_TIM1_CH4OUT   0
#endif
